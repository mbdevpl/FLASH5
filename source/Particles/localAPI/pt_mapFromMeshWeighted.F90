!!****if* source/Particles/localAPI/pt_mapFromMeshWeighted
!!
!! NAME
!!
...
!!  2D axisymmetric (r-z).
!!
!!  This version does weighted interpolation
...
!!   partAttribVec  : Vector containing the calculated attribute values
!!
!!
!!***
