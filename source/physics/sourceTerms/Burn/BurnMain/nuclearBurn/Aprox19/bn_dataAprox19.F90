!!****if* source/physics/sourceTerms/Burn/BurnMain/nuclearBurn/Aprox19/bn_dataAprox19
!!
!! NAME
!!  
!!  bn_dataAprox19
...
!! DESCRIPTION
!!
!!  Contains variables required by the Aprox19 nuclear network
!!
!! NOTES
!!
