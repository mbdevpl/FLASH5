!!****if* source/physics/Eos/EosMain/Gamma/Eos_getParameters
!!
!! NAME
!!
!!  Eos_getParameters
...
subroutine Eos_getParameters(eintSwitch,inputsAreUnchanged,inputTempIsGuess,constantGammaC,&
  ...
  if (present(inputsAreUnchanged)) inputsAreUnchanged = .TRUE.
  if (present(inputTempIsGuess)) inputTempIsGuess = .FALSE.
  if (present(constantGammaC)) constantGammaC = .TRUE.
