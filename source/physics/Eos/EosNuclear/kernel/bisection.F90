!!****if* source/physics/Eos/EosNuclear/kernel/bisection
!!
!! NAME
!!
!!  bisection
...
!! SYNOPSIS
!!
!!  call bisection(real, intent(INOUT)  :: lr,
!!                 real, intent(INOUT)  :: lt0,
!!                 real, intent(INOUT)  :: y,
!!                 real, intent(INOUT)  :: eps0,
!!                 real, intent(INOUT)  :: lt,
!!                  :: bivar,
!!                  :: keyerrt,
!!                  :: keybisect)
!!
...
!subroutine bisection(lr,lt0,y,eps0,bivar,keyerrt,keybisect)

  use eosmodule

  implicit none

  real, intent(INOUT) :: lr,lt0,y,eps0,lt
  integer :: keyerrt
...
subroutine bisection_rho(lr0,lt,y,lpressin,lr,bivar,keyerrr,keybisect)
  ...
  !temporary vars
  real :: lr1,lr2,lrmin,lrmax
  real :: f1,f2,fmid,dlr,lrmid
  real :: d1,d2,d3,tol
  real :: f1a,f2a
