!!****if* source/Grid/localAPI/gr_hypreCreateMatrixFcBAnisoCond
!!
!!  NAME 
!!
!!   gr_hypreCreateAnisoCondMatrixFcB
!!
!!  SYNOPSIS
!!
!!   call gr_hypreCreateAnisoCondMatrixFcB(integer(IN)           :: iVar,
!!                             integer(IN)           :: iFactorB,
!!                             integer(IN)           :: iFactorA,
...
subroutine gr_hypreCreateAnisoCondMatrixFcB(iVar, iFactorB, iFactorA, bcTypes, bcValues, dt, &
...
end subroutine gr_hypreCreateAnisoCondMatrixFcB
