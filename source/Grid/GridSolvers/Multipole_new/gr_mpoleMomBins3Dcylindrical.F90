!!****if* source/Grid/GridSolvers/Multipole_new/gr_mpoleMomBins3Dcylindrical
!!
!! NAME
!!
...
subroutine gr_mpoleMomBins3Dcylindrical (maxQtype)
  ...
  use gr_mpoleData,      ONLY : gr_mpoleNumberInv,              &
...
!           The 3D cylindrical case. The full set of moments for:
!
!                          0 =< L =< gr_mpoleMaxL
!                          0 =< M =< L (cosine part)
!                          1 =< M =< L (sine part)
