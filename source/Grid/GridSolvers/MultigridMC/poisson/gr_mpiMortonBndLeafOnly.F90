!!****if* source/Grid/GridSolvers/MultigridMC/poisson/gr_mpiMortonBndLeafOnly
!!
!! NAME
!!
!!  gr_mpiMortonBndLeafOnly
!!
!! SYNOPSIS
!!
!!  call gr_mpiMortonBndLeafOnly(Integer(in) :: mype,
!!                               Integer(in) :: nprocs,
!!                               Integer(inout) :: tag_offset)
!!
!! DESCRIPTION
!!
!!
