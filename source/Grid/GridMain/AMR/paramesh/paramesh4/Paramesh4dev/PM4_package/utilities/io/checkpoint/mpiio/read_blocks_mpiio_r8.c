...
#ifdef REAL8
extern void get_new_type(int, int, int, int, int*, int, int, int, MPI_Datatype*);
extern void get_udim_mpiio(int, int, int, int, int, int, int, int, int*, int*, int*);

#ifdef UNDERSCORE
void read_blocks_mpiio_r8_ (char* file_name_in, 
#endif
#ifdef DOUBLE_UNDERSCORE
void read_blocks_mpiio_r8__ (char* file_name_in, 
#endif
#ifndef UNDERSCORE 
#ifndef DOUBLE_UNDERSCORE
void read_blocks_mpiio_r8 (char* file_name_in, 
#endif
#endif
			  int*  tot_blocks,
			  int*  lnblocks,
