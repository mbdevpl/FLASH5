...
!!                     both systems have amount of substance in mole
!!
!! NOTES
!!
...
!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
  ...
  ! Physical constants were taken from the 1998 Review of Particle
  ...
  ! Most updated to 2014 CODATA recommended values from http://physics.nist.gov - KW April 2016
  ...
  call pc_addUnit ("mass",           "amu",  1.6605390404271643e-24)
  call pc_addUnit ("temperature",    "eV",   11604.5221)
  ...
  call pc_addUnit ("temperature",    "clTemp",   11604522.1)  ! keV
  ...
  call pc_addConstant ("Newton",              6.67408E-8,               & 
       &                                                  3., -2., -1.,           & 
       &                                                  0., 0.)
  c = 2.99792458E10
  call pc_addConstant ("speed of light",      c,              &  
       &                                                  1., -1., 0.,            & 
       &                                                  0., 0.)
  call pc_addConstant ("Planck",              6.626070040E-27,            & 
       &                                                  2., -1., 1.,            & 
       &                                                  0., 0.)
  call pc_addConstant ("electron charge",     4.80320467299766E-10,       & 
       &                                                  0., 0., 0.,             & 
       &                                                  0., 1.)
  call pc_addConstant ("electron mass",       9.10938356E-28,            & 
       &                                                  0., 0., 1.,             & 
       &                                                  0., 0.)
  call pc_addConstant ("proton mass",        1.672621898E-24,            & 
       &                                                  0., 0., 1.,             & 
       &                                                  0., 0.)
  call pc_addConstant ("fine-structure",      7.2973525664E-3,            & 
       &                                                  0., 0., 0.,             & 
       &                                                  0., 0.)
  call pc_addConstant ("Avogadro",            6.022140857E23,             &  
       &                                                  0., 0., 0.,             & 
       &                                                  0., 0., -1.0)
  call pc_addConstant ("Boltzmann",           1.38064852E-16,             & 
       &                                                  2., -2., 1.,            & 
       &                                                  -1., 0.)
  call pc_addConstant ("ideal gas constant",  8.3144598E7,             & 
       &                                                  2., -2., 1.,            & 
       &                                                  -1., 0., -1.0)
  call pc_addConstant ("Wien",                2.8977729E-1,              & 
       &                                                  1., 0., 0.,             & 
       &                                                  1., 0.)
