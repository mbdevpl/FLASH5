...
MPI_PATH   = /soft/mpich-p4-1.2.7p1-intel11.0-r1
HDF4_PATH  =
HDF5_PATH  = /soft/hdf5-1.6.5-intel11.0-mpichp4-r1
...
NCMPI_PATH = /soft/pnetcdf-1.0.3-intel11.0-mpichp4-r1
MPE_PATH   =
