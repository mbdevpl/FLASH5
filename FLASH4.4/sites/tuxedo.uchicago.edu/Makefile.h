...
#MPI_PATH   = /usr/local/mpich2-1.2.1p1/intel
MPI_PATH   = /opt/mpich2_intel
HDF4_PATH  =
#HDF5_PATH  = /usr/local/hdf5-1.6.10/intel
HDF5_PATH  = /opt/hdf5_intel
#HYPRE_PATH = /home/shravang/software/hypre-2.7.0b
HYPRE_PATH = /opt/hypre
...
#NCMPI_PATH = /usr/local/pnetcdf-1.1.1/intel
NCMPI_PATH = /opt/netcdf_intel
MPE_PATH   =
