# FLASH makefile definitions for BG/Q (MIRA) using GNU compilers
#----------------------------------------------------------------------------
...
CFLAGS_OPT = -DIBM -ggdb -c -O2 -Wuninitialized -D_FORTIFY_SOURCE=2

CFLAGS_DEBUG = -DIBM -ggdb -c -O0 -Wno-div-by-zero -Wundef \
