...
# Remove old results
RESULTS_DIR=$FLASHTEST_OUTPUT/hello
...
$FLASHTEST_BASE/flashTest.py -v -s hello \
                -o $FLASHTEST_OUTPUT \
                -c $FLASH_BASE/sites/hello/FlashTest/config \
                -i $FLASH_BASE/sites/hello/FlashTest/test.info \
