...
ifeq ($(PE_ENV),CRAY)
    ...
    LFLAGS_OPT   = -O2 -fp-model precise -o
    LFLAGS_DEBUG = -g -o
    LFLAGS_TEST  = -list -o
    ...
    FFLAGS_OPT   = -c -r8 -i4 -fastsse -tp bulldozer -Mpreprocess
    ...
    LFLAGS_OPT   = -fastsse -tp bulldozer -o
    LFLAGS_DEBUG = -g -o
    ...
    FFLAGS_DEBUG = -c -fdefault-real-8 -fdefault-double-8 -ffree-line-length-none -O0 -g -fbacktrace -fcheck=bounds,do,mem,pointer -cpp
    FFLAGS_TEST  = -c -fdefault-real-8 -fdefault-double-8 -ffree-line-length-none

    CFLAGS_OPT   = -c -O2
    CFLAGS_DEBUG = -c -O0 -g -fbounds-check
    CFLAGS_TEST  = -c 
