...
HDF4_PATH  =
#HDF5_PATH  = /Users/hmezz/Documents/MacLibs/hdf5-1.8.6
#ZLIB_PATH  = /Users/hmezz/Documents/MacLibs/hdf5-1.8.6/lib
HDF5_PATH = /Users/hmezz/Documents/MacLibs/hdf5-1.8.9
ZLIB_PATH = /Users/hmezz/Documents/MacLibs/hdf5-1.8.9/lib
BLAS_PATH = /usr/local/lib/
SUPERLU_PATH =/Users/hmezz/Documents/MacLibs/SuperLU_4.3
XDMF_PATH  = /Users/hmezz/Documents/MacLibs/XDMF/
VTKXML_PATH= /usr/local/VTK/include/vtk-5.10
PAPI_PATH  =
PAPI_FLAGS =
...
-ffree-line-length-none -Wuninitialize -I/usr/local/include
...
-finit-integer=-999999 -fimplicit-none -I/usr/local/include

FFLAGS_TEST =  -c -fdefault-real-8 -fdefault-double-8 \
-ffree-line-length-none -I/usr/local/include

F90FLAGS =


CFLAGS_OPT =  -c -O2 -Wuninitialized -I/usr/local/include
...
-Wunsafe-loop-optimizations -Wpadded -fstack-check -fstack-protector-all -I/usr/local/include

CFLAGS_TEST = -c -I/usr/local/include
...
CFLAGS_XDMF  = -I/Users/hmezz/Documents/MacLibs/XDMF/Xdmf/libsrc -I{HDF5_PATH}/include/ -I{VTKXML_PATH}/vtklibxml2/libxml/ 
...
#----------------------------------------------------------------------------
  ...
  LIB_HDF4  = 
  LIB_HDF5  = -L${HDF5_PATH}/lib -lhdf5_fortran -lhdf5 -lz -lsz -lm
...
# BLAS
  ...
  LIB_XDMF  = -L${XDMF_PATH}/apple_static/bin/ -L${HDF5_PATH}/lib/ -L/usr/local/VTK/lib/vtk-5.10/ -lvtkXdmf -lXdmf -lvtklibxml2 -lvtkzlib -lvtkhdf5 -lhdf5_fortran -lhdf5 -lz -lstdc++ 
