...
HDF5_PATH   =  $(SOFTWARE)/hdf5-1.6.5
MPI_PATH    =  $(SOFTWARE)/mpich-1.2.7p1/pg
...
FCOMP   =  $(SOFTWARE)/pg6/bin/pgf90
CCOMP   =  $(SOFTWARE)/pg6/bin/pgcc
CPPCOMP =  $(SOFTWARE)/pg6/bin/pgCC
LINK    =  $(SOFTWARE)/pg6/bin/pgf90 -Bstatic
...
CONFIG_LIB = -L/usr/lib/ -Bstatic -lrt
...
CFLAGS_OPT   = -c -O2 -I$(SOFTWARE)/pg6/include/CC
CFLAGS_DEBUG = -c -g 
CFLAGS_TEST  = -c 
