...
MPI_PATH   = /usr/local/mpich-1.2.7p1/nagf95
HDF4_PATH  =
HDF5_PATH  = /usr/local/hdf5/hdf5-1.6.5-nag
...
NCMPI_PATH = /usr/local/pnetcdf-1.0.0-nag
MPE_PATH   =
...
FFLAGS_OPT   = -c -O2 -r8 -mismatch -maxcontin=100 -DNAGF95 #-free
FFLAGS_DEBUG = -c -g -r8 -mismatch -maxcontin=100 -DNAGF95
...
LFLAGS_OPT   = -r8 -Bstatic -o
LFLAGS_DEBUG = -r8 -g -Bstatic -o
LFLAGS_TEST  = -r8 -Bstatic -o
