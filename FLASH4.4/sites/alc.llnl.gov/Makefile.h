...
HDF5path   = /usr/local/hdf5/hdf5-1.6.0_chaos_2.0/parallel
...
CFLAGS       = -I$(HDF5path)/include -c -r8 -i4  -O3 -tpp7 -march=pentium4 -mcpu=pentium4 -ip -unroll -D_LARGEFILE64_SOURCE
...
LIB_HDF5    = -L$(HDF5path)/lib -lhdf5 -lz -L$(MPIpath)/lib -lmpi -lmpio   -lelan -lelan3 -lelanctrl -lrmscall -lpthread \
...
LIB_OPT     = #/usr/local/mpi/pgf90_farg.o
LIB_DEBUG   = -Wl,-rpath,/usr/local/tv/dflt/linux-x86/lib -L/usr/local/tv/dflt/linux-x86/lib -ltvheap
LIB_TEST    =
