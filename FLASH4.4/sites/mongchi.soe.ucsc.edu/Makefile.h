...
#MPI_PATH   = /usr/local/Cellar/mpich2/3.1.2
#MPI_PATH = /usr/local/opt/mpich2/mpich-install
MPI_PATH = /usr/local/opt/mpich2/mpich-install-1.5.3
HDF4_PATH  =
HDF5_PATH  = /usr/local/opt/hdf5-1.8.7
