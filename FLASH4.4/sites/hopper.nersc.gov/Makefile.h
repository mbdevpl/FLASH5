# FLASH makefile definitions for Hopper, a Cray XE6 machine at NERSC.
#
# The software stack is managed by the modules system.  The default
# programming environment is PGI.  I would like to use Intel:
# * module swap PrgEnv-pgi/4.1.40 PrgEnv-intel/4.1.40
#
# Load the following modules before compiling (names as of 9th Aug 13):
# * HDF5: module load cray-hdf5-parallel/1.8.9
# * PNETCDF: module load parallel-netcdf/1.3.1
