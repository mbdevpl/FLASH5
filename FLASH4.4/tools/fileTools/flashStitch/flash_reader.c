...
#ifndef NO_HDF5
#include "hdf5.h"
extern FR_File *FR_open_HDF5(char *filename);
...
#ifndef NO_NCDF
#include "pnetcdf.h"
extern FR_File *FR_open_NCDF(char *filename);
...
#ifndef NO_HDF5
  case FR_HDF5:
    return FR_open_HDF5(filename);
    break;
#endif

#ifndef NO_NCDF
  case FR_NCDF:
    return FR_open_NCDF(filename);
    break;
#endif
