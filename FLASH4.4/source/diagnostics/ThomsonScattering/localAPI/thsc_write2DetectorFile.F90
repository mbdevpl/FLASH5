!!****if* source/diagnostics/ThomsonScattering/localAPI/thsc_write2DetectorFile
!!
!! NAME
!!
!!  thsc_write2DetectorFile
!!
!! SYNOPSIS
!!
!!  call thsc_write2DetectorFile (integer, intent (in) :: detector,
