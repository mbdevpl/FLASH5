!!****if* source/diagnostics/ProtonEmission/localAPI/pem_protonsBlockIDInfo
!!
!! NAME
!!
!!  pem_protonsBlockIDInfo
!!
!! SYNOPSIS
!!
!!  call pem_protonsBlockIDInfo ()
!!
!! DESCRIPTION
!!
!!  Extracts from the emission protons array the following information about the
!!  block ID's:
!!
