!!****if* source/diagnostics/ProtonEmission/localAPI/pem_createProtonTags
!!
!! NAME
!!
!!  pem_createProtonTags
!!
!! SYNOPSIS
!!
!!  call pem_createProtonTags ()
!!
!! DESCRIPTION
!!
!!  Creates a unique global tag number for each emission proton. This is achieved by
