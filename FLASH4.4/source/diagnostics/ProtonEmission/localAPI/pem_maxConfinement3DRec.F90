!!****if* source/diagnostics/ProtonEmission/localAPI/pem_maxConfinement3DRec
!!
!! NAME
!!
!!  pem_maxConfinement3DRec
!!
!! SYNOPSIS
!!
!!  pem_maxConfinement3DRec (integer, intent (in) :: nc,
!!                           real,    intent (in) :: y (:))
!!
!! DESCRIPTION
!!
...
function pem_maxConfinement3DRec (nc,y)
  ...
  use pem_traceODEfunctionData, ONLY :  xmaxCell, ymaxCell, zmaxCell
  ...
  real :: pem_maxConfinement3DRec (1:nc)   ! (compatible to Runge Kutta interfaces)

  pem_maxConfinement3DRec (1:nc) = 0.0
