!!****if* source/diagnostics/ProtonEmission/localAPI/pem_time2FacesParabolicPath1D
!!
!! NAME
!!
!!  pem_time2FacesParabolicPath1D
!!
!! SYNOPSIS
!!
!!  pem_time2FacesParabolicPath1D (real (in) :: pos,
!!                                 real (in) :: vel,
!!                                 real (in) :: acc,
!!                                 real (in) :: minFace,
!!                                 real (in) :: maxFace,
...
real function pem_time2FacesParabolicPath1D (pos, vel, acc, minFace, maxFace, noFaceTime)
  ...
  pem_time2FacesParabolicPath1D = 0.0
