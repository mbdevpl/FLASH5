!!****if* source/diagnostics/ProtonEmission/localAPI/pem_traceBlockProtons3DRec
!!
!! NAME
!!
!!  pem_traceBlockProtons3DRec
!!
!! SYNOPSIS
!!
!!  call pem_traceBlockProtons3DRec (integer (in)    :: protonFirst
