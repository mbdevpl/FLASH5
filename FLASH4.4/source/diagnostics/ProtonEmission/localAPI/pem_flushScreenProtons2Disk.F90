!!****if* source/diagnostics/ProtonEmission/localAPI/pem_flushScreenProtons2Disk
!!
!! NAME
!!
!!  pem_flushScreenProtons2Disk
!!
!! SYNOPSIS
!!
!!  call pem_flushScreenProtons2Disk ()
!!
!! DESCRIPTION
!!
!!  When calling this routine, the emission screen protons accumulated by each processor are
!!  all send to the master processor and processed for writing out to disk. The following
!!  steps are performed:
!!
...
!!  during a proton emission simulation. The screen protons written out will be simply
