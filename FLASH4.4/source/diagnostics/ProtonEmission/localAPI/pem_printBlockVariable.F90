!!****if* source/diagnostics/ProtonEmission/localAPI/pem_printBlockVariable
!!
!! NAME
!!
!!  pem_printBlockVariable
!!
!! SYNOPSIS
!!
!!  call pem_printBlockVariable (integer, intent (in) :: blockID,
...
!! NOTES
!!
!!  Only certain variables (those relevant for proton emission) can be printed right now.
