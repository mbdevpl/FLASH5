!!****if* source/Grid/GridBoundaryConditions/OneRow/Flash2HSE/Grid_applyBCEdgeAllUnkVars
!!
!! NAME
...
#include "constants.h"
  ...
  if(bcType==HYDROSTATIC_F2_NVDIODE .OR. bcType==HYDROSTATIC_F2_NVOUT .OR. bcType==HYDROSTATIC_F2_NVREFL) then
     ...
     call Driver_abortFlash("HYDROSTATIC boundary (non-F2) not yet implemented in Grid_applyBCEdgeAllUnkVars.")
