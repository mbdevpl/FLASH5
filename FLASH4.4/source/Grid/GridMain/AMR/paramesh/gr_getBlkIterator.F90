...
!!                - ANY_BDRY_BLKS        - only those blocks with at least one
!!                                         face on a boundary
!!                - TRAVERSED            - (paramesh)
...
!!             iteration is not restricted to any level.  However, if the nodetype
!!             is REFINEMENT, a valid refinement level must be given.
