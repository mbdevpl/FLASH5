...
contains
    ...
    !!  constants.h
    !!****
    function init_iterator_mfa(nodetype, mfArray, level) result(this)
      use amrex_multifab_module, ONLY : amrex_multifab
        ...
        call amrex_mfiter_build(this%mfi,mfArray(level),tiling=.FALSE.)
        call this%next()
...
!           call amrex_mfiter_build(this%mfi,mf)
        end if
        call this%next()
