!!****if* source/Grid/GridMain/Chombo/AMR/Grid_getGlobalIndexLimits
!!
!! NAME
...
!NOTE:  This is a hack and needs customizing for Chombo.

subroutine Grid_getGlobalIndexLimits(globalIndexLimits)

  use Grid_data, ONLY : gr_gIndexSize, lrefine_max
...
#include "Flash.h"
  ...
  globalIndexLimits = gr_gIndexSize * maxBlocksAlongDimension
