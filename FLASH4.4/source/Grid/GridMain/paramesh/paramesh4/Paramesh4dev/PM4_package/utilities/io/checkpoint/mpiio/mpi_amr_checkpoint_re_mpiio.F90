...
!---------------------------------------------------------------------------
     ...
     &                               user_attr_5
      ...
      integer :: ngid, lnblocks_old, itemp
...
! set limits on data arrays
      ...
      iorder(1) = size(ordering,dim=1)
      print *,' iorder = ',iorder(1)
      iorder(2) = size(ordering,dim=2)
      print *,' iorder = ',iorder(2)
      iorder(3) = size(ordering,dim=3)
      print *,' iorder = ',iorder(3)
      iorder(4) = size(ordering,dim=4)
      print *,' iorder = ',iorder(4)
