...
! Set up which field to clean
      ...
      ! Use Balsara interpolation
      Call prol_fc_dbz_init(2, i_divf_fc_vars)
      print *,' Using Balsara interpolation '
...
990      format('ex:error proc ',i3,' block l= ',5(2x,i3),2x,f7.4,2x, & 
     &       f7.4)
      ...
      real :: divb, divb_max, dx, dy, dz, divb_max_all
      integer :: lb, i, j, k, ierr, ivar, nguard0
