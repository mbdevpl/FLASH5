...
void CREATE_File_matlab_r4 (char* file_name_in, hid_t* file_id) {
...
void WRITE_Header_matlab_r4(hid_t* file_id, int* tot_blocks,
			  float* user_attr_1,
			  float* user_attr_2,
			  float* user_attr_3,
			  float* user_attr_4,
...
void CREATE_Block_data_type_matlab_r4(hid_t* block_type_id, 
				   int* mdim, 
				   int* ndim, 
				   int* ngid, 
				   int* mflags, 
...
void CREATE_Block_data_set_matlab_r4(hid_t* dset_block, 
				  hid_t* file_id,
				  hid_t* block_type_id,
				  int*   tot_blocks_wr)
{
...
void WRITE_Blocks_matlab_r4(hid_t* file_id, 
			 hid_t* dset_block, 
			 hid_t* block_type_id, 
			 int* max_lnblocks, 
			 int* n_to_left, 
...
#ifdef UNDERSCORE
void write_blocks_matlab_r4_ (char* file_name_in, 
#endif
#ifdef DOUBLE_UNDERSCORE
void write_blocks_matlab_r4__ (char* file_name_in, 
#endif
#ifndef UNDERSCORE 
#ifndef DOUBLE_UNDERSCORE
void write_blocks_matlab_r4 (char* file_name_in, 
#endif
#endif
			   int*  tot_blocks,
			   int*  tot_blocks_wr,
			   ...
			   float* user_attr_5)
{
  ...
  CREATE_File_matlab_r4(file_name_in, &file_id);

  WRITE_Header_matlab_r4(&file_id, tot_blocks,
		       user_attr_1,
		       user_attr_2,
		       user_attr_3,
		       user_attr_4,
  ...
  CREATE_Block_data_type_matlab_r4(&block_type_id, 
				 mdim, 
				 ndim, 
				 ngid, 
				 mflags,
  ...
  CREATE_Block_data_set_matlab_r4(&dset_block, 
				&file_id, 
				&block_type_id, 
				tot_blocks_wr);
  
  WRITE_Blocks_matlab_r4(&file_id, 
		       &dset_block, 
		       &block_type_id, 
		       max_lnblocks, 
		       n_to_left, 
