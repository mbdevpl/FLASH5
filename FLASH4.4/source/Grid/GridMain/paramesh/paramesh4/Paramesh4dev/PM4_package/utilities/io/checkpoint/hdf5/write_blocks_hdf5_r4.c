...
#ifndef REAL8
void CREATE_File_hdf5_r4 (char* file_name_in, hid_t* file_id) {
...
void WRITE_Header_hdf5_r4(hid_t* file_id, int* tot_blocks,
			  float* user_attr_1,
			  float* user_attr_2,
			  float* user_attr_3,
			  float* user_attr_4,
...
void CREATE_Block_data_type_hdf5_r4(hid_t* block_type_id, 
				   int* mdim, 
				   int* ndim, 
				   int* ngid, 
				   int* mflags, 
...
void CREATE_Block_data_set_hdf5_r4(hid_t* dset_block, 
				  hid_t* file_id,
				  hid_t* block_type_id,
				  int*   tot_blocks_wr)
{
...
void WRITE_Blocks_hdf5_r4(hid_t* file_id, 
			 hid_t* dset_block, 
			 hid_t* block_type_id, 
			 int* max_lnblocks, 
			 int* n_to_left, 
			 ...
			 int   iorder[])
{
  ...
  for (lb = 0; lb < *max_lnblocks; lb++) {
	...
	*(block_pointer+off) = bnd_box[(2 * *mdim * lb) + i];
	...
	block_pointer_to_var(unk, iorder, *nvar, *nx, *ny, *nz,
			     kstart, kend,
			     jstart, jend,
			     istart, iend,
			     checkp_on_cc, 0, 0, lb,
	...
	block_pointer_to_var(facevarx, iorder, *nbndvar, *nx+1, *ny, *nz,
			     kstart, kend,
			     jstart, jend,
			     istart, iend+1,
			     checkp_on_fc, 2, 0, lb,
	...
	block_pointer_to_var(facevary, iorder, *nbndvar, *nx, *ny+k2d, *nz,
			     kstart, kend,
			     jstart, jend+k2d,
			     istart, iend,
			     checkp_on_fc, 2, 1, lb,
	...
	block_pointer_to_var(facevarz, iorder, *nbndvar, *nx, *ny, *nz+k3d,
			     kstart, kend+k3d,
			     jstart, jend,
			     istart, iend,
			     checkp_on_fc, 2, 2, lb,
	...
	block_pointer_to_var(unk_e_x, iorder, *nbndvare, *nx, *ny+k2d, *nz+k3d,
			     kstart, kend+k3d,
			     jstart, jend+k2d,
			     istart, iend,
			     checkp_on_ec, 2, 0, lb,
	...
	block_pointer_to_var(unk_e_y, iorder, *nbndvare, *nx+1, *ny, *nz+k3d,
			     kstart, kend+k3d,
			     jstart, jend,
			     istart, iend+1,
			     checkp_on_ec, 2, 1, lb,
	...
	block_pointer_to_var(unk_e_z, iorder, *nbndvare, *nx+1, *ny+k2d, *nz,
			     kstart, kend,
			     jstart, jend+k2d,
			     istart, iend+1,
			     checkp_on_ec, 2, 2, lb,
	...
	block_pointer_to_var(unk_n, iorder, *nbndvarc, *nx+1, *ny+k2d, *nz+k3d,
			     kstart, kend+k3d,
			     jstart, jend+k2d,
			     istart, iend+1,
			     checkp_on_nc, 0, 0, lb,
...
#ifdef UNDERSCORE
void write_blocks_hdf5_r4_ (char* file_name_in, 
#endif
#ifdef DOUBLE_UNDERSCORE
void write_blocks_hdf5_r4__ (char* file_name_in, 
#endif
#ifndef UNDERSCORE 
#ifndef DOUBLE_UNDERSCORE
void write_blocks_hdf5_r4 (char* file_name_in, 
#endif
#endif
			   int*  tot_blocks,
			   int*  tot_blocks_wr,
                           ...
                           int iorder[])
{
  ...
  CREATE_File_hdf5_r4(file_name_in, &file_id);

  WRITE_Header_hdf5_r4(&file_id, tot_blocks,
		       user_attr_1,
		       user_attr_2,
		       user_attr_3,
		       user_attr_4,
  ...
  CREATE_Block_data_type_hdf5_r4(&block_type_id, 
				 mdim, 
				 ndim, 
				 ngid, 
				 mflags,
  ...
  CREATE_Block_data_set_hdf5_r4(&dset_block, 
				&file_id, 
				&block_type_id, 
				tot_blocks_wr);
  
  WRITE_Blocks_hdf5_r4(&file_id, 
		       &dset_block, 
		       &block_type_id, 
		       max_lnblocks, 
		       n_to_left, 
