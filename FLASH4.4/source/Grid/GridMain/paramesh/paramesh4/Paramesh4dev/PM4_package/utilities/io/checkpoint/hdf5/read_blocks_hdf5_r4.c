...
#ifndef REAL8
void CREATE_Block_data_type_hdf5_r4(hid_t*,int*,int*,int*,int*,int*,int*,
				    int*,int*,int*,int*,int*,int*,int*,int*);

void OPEN_File_hdf5_r4 (char* file_name_in, hid_t* file_id) {
...
void READ_Header_hdf5_r4(hid_t* file_id, int* tot_blocks,
			 float* user_attr_1,
			 float* user_attr_2,
			 float* user_attr_3,
			 float* user_attr_4,
...
void OPEN_Block_data_set_hdf5_r4(hid_t* dset_block, 
				 hid_t* file_id)
{
...
void READ_Blocks_hdf5_r4(hid_t* file_id, 
			 hid_t* dset_block, 
			 hid_t* block_type_id, 
			 int* tot_blocks, 
			 int* lnblocks, 
...
#ifdef UNDERSCORE
void read_blocks_hdf5_r4_ (char* file_name_in, 
#endif
#ifdef DOUBLE_UNDERSCORE
void read_blocks_hdf5_r4__ (char* file_name_in, 
#endif
#ifndef UNDERSCORE 
#ifndef DOUBLE_UNDERSCORE
void read_blocks_hdf5_r4 (char* file_name_in, 
#endif
#endif
			  int*  tot_blocks,
			  int*  lnblocks,
			  ...
			  int iorder[])
{
  ...
  OPEN_File_hdf5_r4(file_name_in, &file_id);

  READ_Header_hdf5_r4(&file_id, tot_blocks,
		      user_attr_1,
		      user_attr_2,
		      user_attr_3,
		      user_attr_4,
  ...
  OPEN_Block_data_set_hdf5_r4(&dset_block, 
			      &file_id);
  
  READ_Blocks_hdf5_r4(&file_id, 
		      &dset_block, 
		      &block_type_id, 
		      tot_blocks, 
		      lnblocks, 
