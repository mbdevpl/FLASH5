!!****if* source/Grid/GridSolvers/Multipole_new/gr_mpoleMomBins2Dcylindrical
!!
!! NAME
!!
...
!           The 2D cylindrical case. Only a subset of moments for:
!
!                          0 =< L =< gr_mpoleMaxL
!                               M = 0 (cosine part)
!
...
!             xy-plane and around the z-axis. But in the 2D cylindrical case
...
!
!
!    ...If a symmetry plane is assumed along the radial part of the domain, the
!       overall moment values including the omitted symmetry part can be calculated
!       from the existing moments by the following rule:
!
