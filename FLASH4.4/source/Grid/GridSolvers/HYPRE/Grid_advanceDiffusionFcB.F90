!!****if* source/Grid/GridSolvers/HYPRE/Grid_advanceDiffusionFcB
!!
!! NAME
...
!!                    limited support for OUTSTREAM, in the HYPRE implementation. !!DEV: verify this!
...
!!! END TEMP
  ...
  call Timers_start("Grid_advanceDiffusionFcB")   
...
!!$  call Timers_stop ("Diffusion Barrier")
  ...
  !!-----------------------------------------------------------------------
  call gr_hypreExchangeFacBFcB (iFactorB, blockCount, blockList)  
...
!!$  pause
  ...
  call Timers_stop("Grid_advanceDiffusionFcB") 
