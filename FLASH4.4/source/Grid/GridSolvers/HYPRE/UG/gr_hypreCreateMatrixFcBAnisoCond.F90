!!****if* source/Grid/GridSolvers/HYPRE/UG/gr_hypreCreateMatrixFcBAnisoCond
!!
!!  NAME 
!!
!!   gr_hypreCreateMatrixFcBAnisoCond
!!
!!  SYNOPSIS
!!
!!   call gr_hypreCreateMatrixFcBAnisoCond(integer(IN)           :: iVar,
!!                             integer(IN)           :: iFactorB,
!!                             integer(IN)           :: iFactorA,
...
subroutine gr_hypreCreateMatrixFcBAnisoCond(iVar, iFactorB, iFactorA, bcTypes, bcValues, dt, &
