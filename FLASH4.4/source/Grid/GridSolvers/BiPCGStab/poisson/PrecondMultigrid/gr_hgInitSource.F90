!!****if* source/Grid/GridSolvers/BiPCGStab/poisson/PrecondMultigrid/gr_hgInitSource
!!
!! NAME
!!  gr_hgInitSource
!! 
...
subroutine gr_hgInitSource (isrc, isoln)
  ...
  use gr_hgData, ONLY :gr_hgMeshRefineMax,gr_hgMeshRefineMin,gr_hgAvgSource
...
#include "Flash_mpi.h"
  ...
  do i = gr_hgMeshRefineMax-1, gr_hgMeshRefineMin, -1  !1, -1
