!!****if* source/Grid/GridSolvers/BiPCGStab/poisson/PrecondHYPRE/gr_bicgApplyPrecond
!!
!! NAME
!!
!!  gr_bicgApplyPrecond
...
!!$    character(len=32) :: matfile
  ...
  call Timers_start("gr_bicgApplyPrecond")    
...
!!$  pause  
  ...
  call Timers_stop("gr_bicgApplyPrecond") 
