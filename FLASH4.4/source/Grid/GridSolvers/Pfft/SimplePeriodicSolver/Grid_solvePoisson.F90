!!****if* source/Grid/GridSolvers/Pfft/SimplePeriodicSolver/Grid_solvePoisson
!!
!! NAME
!!
!!  Grid_solvePoisson
...
!!   FFT based method for periodic problems on a uniform grid.
!!   
...
!!  bcTypes - boundary types along various faces, for this
!!            implementation only GRID_PDE_BND_PERIODIC is valid.
!!  bcValues - the values to boundary conditions, currently not used
!!  poisfact -  factor to be used in calculation
!!
!! NOTES
!!
!!  The symbol mentioned above for bcTypes is declared as a FORTRAN PARAMETER in
!!  the module Grid_interfaces.  Code using this interface should refer to that
!!  module with a USE statement, like this:
!!
!!    use Grid_interface, ONLY : GRID_PDE_BND_PERIODIC, Grid_solvePoisson
!!
!!***
