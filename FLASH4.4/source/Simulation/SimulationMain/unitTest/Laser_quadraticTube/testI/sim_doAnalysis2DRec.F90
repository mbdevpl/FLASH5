!!****if* source/Simulation/SimulationMain/unitTest/Laser_quadraticTube/testI/sim_doAnalysis2DRec
!!
!!  NAME 
!!
!!   sim_doAnalysis2DRec
...
!!  SYNOPSIS
!!
!!   sim_doAnalysis2DRec (logical (out) :: perfect)
!!
!!  DESCRIPTION
!!
!!   This routine performs the analysis on the launched rays for 2D geometries.
!!
!! ARGUMENTS
!!
...
subroutine sim_doAnalysis2DRec (perfect)
  ...
  if (sim_globalMe == MASTER_PE) then
      ...
      select case (sim_lasersOrientation)
        ...
        case default
          ...
          call Driver_abortFlash ('[sim_doAnalysis2DRec] ERROR: Lasers orientation bad!')
...
!
  return
end subroutine sim_doAnalysis2DRec
