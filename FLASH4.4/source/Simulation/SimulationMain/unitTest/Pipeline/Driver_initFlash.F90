!!****if* source/Simulation/SimulationMain/unitTest/Pipeline/Driver_initFlash
!!
!! NAME
!!
!!  Driver_initFlash
...
!! DESCRIPTION
!!
!!  Stripped down version of the original for the Pipeline unit test.
...
subroutine Driver_initFlash ()
  ...
  use IO_interface,                ONLY : IO_init,                 &
                                          IO_outputInitial
  use Pipeline_interface,          ONLY : Pipeline_init
