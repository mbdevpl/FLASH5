!!****if* source/Simulation/SimulationMain/unitTest/ProtonImaging/CircleDeflection/Driver_evolveFlash
!!
!! NAME
!!
!!  Driver_evolveFlash
...
!! DESCRIPTION
!!
!!  Simple stripped down version for testing the Proton Imaging unit. 
!!
!! NOTES
!!
!!***
