!!****if* source/Simulation/SimulationMain/unitTest/ProtonImaging/CircleDeflection/Driver_initFlash
!!
!! NAME
!!
!!  Driver_initFlash
...
!! DESCRIPTION
!!
!!  Stripped down version of the original for the Proton Imaging unit test.
