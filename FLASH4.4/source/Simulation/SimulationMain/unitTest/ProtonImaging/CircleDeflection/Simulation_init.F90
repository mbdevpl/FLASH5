!!****if* source/Simulation/SimulationMain/unitTest/ProtonImaging/CircleDeflection/Simulation_init
!!
!! NAME
!!
!!  Simulation_init
...
!
!
!     ...Set up special beam coordinates.
!
!
!  call sim_setupCrossInSquareXY ()   ! not used anymore
  call sim_setupCircleXY ()
!
!
!     ...Ready!
!
