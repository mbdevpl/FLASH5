!!****if* source/Simulation/SimulationMain/magnetoHD/MagneticDoughnut/Simulation_init
!!
!! NAME
!!
!!  Simulation_init
...
#include "Flash.h"
  ...
  call RuntimeParameters_get('r0',      sim_r0)
  call RuntimeParameters_get('z0',      sim_z0)
  call RuntimeParameters_get('r1',      sim_r1)
  call RuntimeParameters_get('delta',   sim_delta)
