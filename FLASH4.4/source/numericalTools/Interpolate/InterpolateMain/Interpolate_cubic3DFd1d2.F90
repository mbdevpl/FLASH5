!!****if* source/numericalTools/Interpolate/InterpolateMain/Interpolate_cubic3DFd1d2
!!
!! NAME
!!
...
!
  ...
  if (notRescaled) then
      call Logfile_stamp     (x, ' = rescaled x coordinate [Interpolate_cubic3DFd1d2]'        )
      call Logfile_stamp     (y, ' = rescaled y coordinate [Interpolate_cubic3DFd1d2]'        )
      call Logfile_stamp     (z, ' = rescaled z coordinate [Interpolate_cubic3DFd1d2]'        )
      call Driver_abortFlash ('[Interpolate_cubic3DFd1d2] ERROR: [x,y,z] triple not rescaled!')
  end if
!
!
...
!                                                                                   ! used for         * count
!
  b (1:16) = ((a (4:64:4) * x + a (3:63:4)) * x + a (2:62:4)) * x + a (1:61:4)      ! f,dy,dy2,dz,dz2,dydz  48
  c (1:4)  = ((b (4:16:4) * y + b (3:15:4)) * y + b (2:14:4)) * y + b (1:13:4)      ! f,dz,dz2              12

  Interpolate_cubic3DFd1d2 (1) = ((c (4) * z    + c (3)) * z  + c (2)) * z + c (1)  ! -> f                   3
  Interpolate_cubic3DFd1d2 (4) =  (c (4) * z1p5 + c (3)) * z2 + c (2)               ! -> dz                  2
  Interpolate_cubic3DFd1d2 (7) =   c (4) * z6   + c (3) + c (3)                     ! -> dz2                 1
  
  c (1:4) = (b (4:16:4) * y1p5 + b (3:15:4)) * y2 + b (2:14:4)                      ! dy,dydz                8

  Interpolate_cubic3DFd1d2 (3)  = ((c (4) * z    + c (3)) * z  + c (2)) * z + c (1) ! -> dy                  3
  Interpolate_cubic3DFd1d2 (10) =  (c (4) * z1p5 + c (3)) * z2 + c (2)              ! -> dydz                2

  c (1:4) = b (4:16:4) * y6 + b (3:15:4) + b (3:15:4)                               ! dy2                    4

  Interpolate_cubic3DFd1d2 (6) = ((c (4) * z + c (3)) * z + c (2)) * z + c (1)      ! -> dy2                 3

  b (1:16) =  (a (4:64:4) * x1p5 + a (3:63:4)) * x2 + a (2:62:4)                    ! dx,dxdy,dxdz          32
  c (1:4)  = ((b (4:16:4) * y    + b (3:15:4)) * y  + b (2:14:4)) * y + b (1:13:4)  ! dx,dxdz               12

  Interpolate_cubic3DFd1d2 (2) = ((c (4) * z    + c (3)) * z  + c (2)) * z + c (1)  ! -> dx                  3
  Interpolate_cubic3DFd1d2 (9) =  (c (4) * z1p5 + c (3)) * z2 + c (2)               ! -> dxdz                2

  c (1:4) = (b (4:16:4) * y1p5 + b (3:15:4)) * y2 + b (2:14:4)                      ! dxdy                   8
  
  Interpolate_cubic3DFd1d2 (8) = ((c (4) * z + c (3)) * z + c (2)) * z + c (1)      ! -> dxdy                3

  b (1:16) =   a (4:64:4) * x6 + a (3:63:4) + a (3:63:4)                            ! dx2                   16
  c (1:4)  = ((b (4:16:4) * y  + b (3:15:4)) * y + b (2:14:4)) * y + b (1:13:4)     ! dx2                   12

  Interpolate_cubic3DFd1d2 (5) = ((c (4) * z + c (3)) * z + c (2)) * z + c (1)      ! -> dx2                 3
!                                                                                                          ---
!                                                                                                total =   177
!
!     ...Ready!
