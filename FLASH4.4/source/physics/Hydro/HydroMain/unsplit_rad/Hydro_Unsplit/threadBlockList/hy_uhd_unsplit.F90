!!****if* source/physics/Hydro/HydroMain/unsplit_rad/Hydro_Unsplit/threadBlockList/hy_uhd_unsplit
!!
!! NAME
!!
!!  hy_uhd_unsplit
...
#include "UHD.h"
  ...
  !$omp faceAreas,hy_SpcR,hy_SpcL,hy_SpcSig) &
  !$omp shared(blockCount,blockList,blockNeedsFluxCorrect,blockMustStoreFluxes,&
  !$omp dt,dtOld,gcMask,gcMaskLogged,hy_units,&
  !$omp hy_unsplitEosMode,hy_useGravity,hy_gref,hy_fluxCorrect,&
  !$omp hy_updateHydroFluxes,hy_eosModeAfter,&
  !$omp hy_geometry,hy_fluxCorVars,hy_fullRiemannStateArrays,hy_fullSpecMsFluxHandling,&
