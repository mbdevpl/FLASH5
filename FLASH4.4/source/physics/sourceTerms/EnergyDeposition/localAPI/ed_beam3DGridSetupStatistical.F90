!!****if* source/physics/sourceTerms/EnergyDeposition/localAPI/ed_beam3DGridSetupStatistical
!!
!! NAME
!!
...
!! SYNOPSIS
!!
!!  call ed_beam3DGridSetupStatistical (logical, intent (in)    :: seedInitialize,
...
!! DESCRIPTION
!!
!!  Sets up information needed for establishing a statistical cross sectional grid for a particular
!!  ellipsoidal 3D beam. Currently this consists only in setting the a seed value for a random
!!  uniform number generator supplied by Fortran 90 and the values for the maximum seed and the
!!  seed stepping number.
!!
!! ARGUMENTS
!!
