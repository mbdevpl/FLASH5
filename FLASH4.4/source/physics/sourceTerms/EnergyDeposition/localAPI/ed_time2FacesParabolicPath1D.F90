!!****if* source/physics/sourceTerms/EnergyDeposition/localAPI/ed_time2FacesParabolicPath1D
!!
!! NAME
!!
...
!! SYNOPSIS
!!
!!  ed_time2FacesParabolicPath1D (real (in) :: pos,
!!                                real (in) :: vel,
!!                                real (in) :: acc,
!!                                real (in) :: minFace,
!!                                real (in) :: maxFace,
...
!!  will potentially be called many many times during ray tracing, a more clever way of
...
!!
!!  2) The position of the object does not have to be between the two faces. It can be
...
real function ed_time2FacesParabolicPath1D (pos, vel, acc, minFace, maxFace, noFaceTime)
  ...
  ed_time2FacesParabolicPath1D = 0.0
