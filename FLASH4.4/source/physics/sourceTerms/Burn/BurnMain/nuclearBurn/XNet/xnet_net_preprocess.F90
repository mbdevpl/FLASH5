...
Subroutine match_react(data_dir)
  ...
  Write(lun_matchr,"(9a5,1es10.3)") (nname(nflx(1:3,i)),arrow,nname(nflx(4:7,i)),descx(i),rvar,i=1,mflx)
  ...
  Do ii = 1, mflx
    ...
    Do k = 1, le(3)
      If ( abs(ifl1(k)) == ii ) Then
        Write(lun_ndiag,"(9a5,2i2,i6,1es12.4)") &
          & nname(n1(1,k)),blank5,blank5,arrow,nname(n1(2:4,k)),blank5,desc1(k),ires1(k),irev1(k),ifl1(k),q1(k)
        comtest = comtest + 1
    ...
    Do k = 1, le(7)
      If ( abs(ifl2(k)) == ii ) Then
        Write(lun_ndiag,"(9a5,2i2,i6,1es12.4)") &
          & nname(n2(1:2,k)),blank5,arrow,nname(n2(3:6,k)),desc2(k),ires2(k),irev2(k),ifl2(k),q2(k)
        comtest = comtest + 1
    ...
    Do k = 1, le(8)
      If ( abs(ifl3(k)) == ii ) Then
        Write(lun_ndiag,"(9a5,2i2,i6,1es12.4)") &
          & nname(n3(1:3,k)),arrow,nname(n3(4:5,k)),blank5,blank5,desc3(k),ires3(k),irev3(k),ifl3(k),q3(k)
        comtest = comtest + 1
