...
#include "Flash.h"
    ...
    do i1 = 1,quad_nt
        ...
        ! DS = C*B
        call DGEMM('N', 'T', 6, nee, 6, 1., C, 6, Bt, nee, 0., DS, 6)
        ...
        tempD = 0.
        call DAXPY(nen_e*nen_e, S(1)*dV0, dXX, 1, tempD, 1)
        call DAXPY(nen_e*nen_e, S(2)*dV0, dYY, 1, tempD, 1)
        call DAXPY(nen_e*nen_e, S(3)*dV0, dZZ, 1, tempD, 1)
        call DAXPY(nen_e*nen_e, S(4)*dV0, dYZ2, 1, tempD, 1)
        call DAXPY(nen_e*nen_e, S(5)*dV0, dXZ2, 1, tempD, 1)
        call DAXPY(nen_e*nen_e, S(6)*dV0, dXY2, 1, tempD, 1)
        ! Load into ke:
