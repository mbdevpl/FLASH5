...
! Compute element mass matrix for a quadratic 27 node hexahedron
    ...
    do i1 = 1,quad_nt
        ...
        ! Build me
        !me = me + rho(e)*(N'*N)*dV0
        call DGEMM('T','N', nee, nee, NDIM, MatDensity*dV0, N, NDIM, & 
		           N, NDIM, 1., me, nee)
        !me = me + MatDensity(e)*dV0*matmul(Transpose(N),N)
