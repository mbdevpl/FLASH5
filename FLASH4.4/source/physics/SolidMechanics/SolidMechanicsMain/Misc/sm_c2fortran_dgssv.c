...
typedef long fptr;  /* 32-bit by default */ /*Changed to long for 64-bit machines*/
...
void
sm_c2fortran_dgssv_(int *iopt, int *n, int *nnz, int *nrhs, 
 ...
 */
	...
	*f_factors = (fptr) LUfactors;
	...
	fprintf(stderr,"Invalid iopt=%d passed to sm_c2fortran_dgssv()\n",*iopt);
	exit(-1);
    }
}
