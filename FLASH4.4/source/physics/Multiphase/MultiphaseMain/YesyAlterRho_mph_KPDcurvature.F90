...
if (refLev .eq. 1) print*,th,0.5*(rho1+rho2),aa,rho2x(i+1,j,k),rho2x(i+1,j,k)*(rho2/rho2)/aa
if (refLev .eq. 1) print*,rho1+aa*(rho2-rho1)
                 rho1x(i+1,j,k) = rho1x(i+1,j,k)*(rho1/rho2)/aa
                 rho2x(i+1,j,k) = rho2x(i+1,j,k)*(rho2/rho2)/aa 
if (refLev .eq. 1) print*,rho1x(i+1,j,k),rho2x(i+1,j,k)
