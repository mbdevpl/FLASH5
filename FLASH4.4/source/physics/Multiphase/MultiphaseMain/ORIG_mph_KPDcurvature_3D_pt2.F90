...
!
        ...
        subroutine mph_KPDcurvature3DCC(s,crv,rho1x,rho2x,rho1y,rho2y, &
...
print*,"SIG",crv(5,5,5),"AFT"!s(5,5,5)!,crv(5,5,5),rho1x(5,5,5),rho2x(5,5,5),rho1y(5,5,5),rho2y(5,5,5)
call Driver_abortFlash("MPH Break")
      ...
      end subroutine mph_KPDcurvature3DCC
