...
#include "Flash.h"
        ...
        real :: phiXP,phiXM,phiYP,phiYM,xP,xM,yP,yM,eX,phiZP,phiZM,zP,zM
        ...
        do k = kz1,kz2
           do j = jy1,jy2
              do i = ix1,ix2
               ...
               !=================================================================
               ! phi Z+
               if ( (soo(i,j,k+1)*soo(i,j,k+2)).GT.0. .AND. (soo(i,j,k+1)*soo(i,j,k)).GT.0.) then
                  phiZP = soo(i,j,k)
                  zP = dz/2.
               else
                  phiZP = soo(i,j,k+1)
               ...
               Dij = soo(i,j,k) / &
                     ( ( (phiXP-phiXM)/(MAX((xP-xM),(dx/1000.0))) )**2.0 + &
                       ( (phiYP-phiYM)/(MAX((yP-yM),(dx/1000.0))) )**2.0 + &
                       ( (phiZP-phiZM)/(MAX((zP-zM),(dx/1000.0))) )**2.0 )**0.5
               ...
               !------------------------------------------------------
                 ...
                 if (SIGN(1.0,s(i,j,k)) .NE. SIGN(1.0,so(i,j,k))) then
