!!****if* source/physics/materialProperties/Opacity/OpacityMain/Multispecies/method/Integrate/op_LaguerreCoefficients
!!
!! NAME
!!
...
!
  ...
  do i = 2,n
     x = real (i)
     LagA (i) = x + x + alpha - one
     LagB (i) = (x - one) * (x + alpha - one)
  end do
!
!
!   ...Ready! 
