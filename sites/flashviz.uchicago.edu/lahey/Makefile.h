...
HDF5path   = /usr/local/hdf5-1.6.2
MPIpath    = /usr/local/mpich-1.2.6-gcc-lahey
...
NCMPI_PATH = /usr/local/pnetcdf-0.9.4
MPE_PATH   =
...
FCOMP      = /usr/local/mpich-1.2.6-gcc-lahey/bin/mpif90
CCOMP      = gcc
CPPCOMP    = gcc
LINK       = /usr/local/mpich-1.2.6-gcc-lahey/bin/mpif90
...
LIB_NCMPI   =  -L$(NCMPI_PATH)/lib -lpnetcdf -L$(INTEL_PATH)/lib -lirc
