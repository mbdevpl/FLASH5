# FLASH makefile definitions for Cray XT3 System, Jaguar at ORNL
#
# The XT3 makes use of modules.  This Makefile.h has not been 
# tested with hdf5 or parallel netcdf yet.
#
...
FFLAGS_OPT   = -c -r8 -i4 -fastsse -Minfo -Mneginfo -target=catamount #Didn't work yet but should soon -Mipa=fast,inline
