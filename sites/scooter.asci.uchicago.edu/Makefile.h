...
HDF5path   = /usr/local/hdf5-1.6.5/lahey
...
NCMPI_PATH = /usr/local/pnetcdf-1.0.0-pgcc
MPE_PATH   =
...
LIB_MPI     = -lmpich -lm -L/opt/intel_fc_91036/lib -lpthread -lz  -lirc_s
LIB_HDF5    = #-static -L$(HDF5path)/lib -lhdf5 -lz -shared -Wl,-rpath,$(HDF5path)/lib -lpthread
LIB_HDF5    = -L$(HDF5path)/lib -lhdf5 -lz -Wl,-rpath,$(HDF5path)/lib -lpthread

LIB_PAPI    = $(PAPI_PATH)/lib/libpapi.a $(PAPI_PATH)/lib/_fixunssfdi.o
LIB_PNG     = -lpng -lz

LIB_OPT     =
LIB_DEBUG   = #-L$(TOTALVIEW_PATH)/lib -ltvheap -Wl,-rpath,$(TOTALVIEW_PATH)/lib
LIB_TEST    =
