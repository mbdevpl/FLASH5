...
MPI_PATH   = /opt/ompi/intel/1.5.5rc1
HDF4_PATH  =
HDF5_PATH  = /opt/hdf5/ompi_intel/1.8.8
HYPRE_PATH = /opt/hypre/ompi_intel/2.8.0b

ifeq ("$(USEOPENMP)", "1")
HYPRE_PATH=/opt/hypre/ompi_intel/2.8.0b_omp
endif
...
NCMPI_PATH = /opt/netcdf/ompi_intel/1.2.0
MPE_PATH   =
