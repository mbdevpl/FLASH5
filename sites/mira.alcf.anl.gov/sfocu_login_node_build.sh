...
cd ../../tools/sfocu
make SITE=mira.alcf.anl.gov clean
...
make SITE=mira.alcf.anl.gov NO_MPI=True NO_NCDF=True CCOMP=xlc_r CFLAGS_HDF5="-I${HDF5_PATH}/include -DH5_USE_16_API" LIB_HDF5="-L${HDF5_PATH}/lib -lhdf5"
