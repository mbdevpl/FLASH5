...
FFLAGS_OPT   = -O -qintsize=4 -qrealsize=8 -qfixed -qnosave -c \
...
CFLAGS_OPT   = -O -DIBM -DNOUNDERSCORE -c -qlanglvl=extended \
               -qarch=440 -qtune=auto -qcache=auto -qmaxmem=16384
