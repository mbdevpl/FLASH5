...
; this function does a cell-wise exponentiation of amr1, taken to the
; given base (default is 10)
...
for n=0, amr1.maxlevel do begin
	...
	datanew = base^(*(*amr1.levels[n].fabptr)[m].dataptr) 
